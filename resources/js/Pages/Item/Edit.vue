    ...
    <div class="p-6 max-w-2xl mx-auto">
        ...
        <form @submit.prevent="submit" enctype="multipart/form-data">
            <div class="mb-4">
                ...
                <input type="text" v-model="form.title" name="title" class="form-control w-full border rounded px-3 py-2" />
            ...
            <div class="mb-4">
                ...
                <img v-if="item.media && item.media.length" :src="item.media[0].original_url"
            ...
            <div class="mb-4">
                ...
                <div v-if="form.image" class="mt-2 text-sm text-gray-600">Selected: {{ form.image.name }}</div>
